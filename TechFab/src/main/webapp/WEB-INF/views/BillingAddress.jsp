<%@ include file="header.jsp" %>
  ...
  <div class="panel-body">
	...
	<div class="form-group">
        <form:input path="streetAddress"  class="form-control" placeholder="Street Address" tabindex="1" />
        <form:errors path="streetAddress"  class="form-control" cssClass="errors"></form:errors>
              	...
              	<div class="form-group">
             <form:input path="flatNo"  class="form-control" placeholder="Flatno" tabindex="1"/>
                <form:errors path="flatNo"  class="form-control" cssClass="errors"></form:errors>
              	...
              	<div class="form-group">
        <form:input path="city"  class="form-control" placeholder="city" tabindex="1"/>
              	...
              	<div class="form-group">
                    <form:input path="state"  class="form-control" placeholder="State" tabindex="1"/>
             	...
             	<div class="form-group">
        <form:input path="postalCode"  class="form-control" placeholder="postal code" tabindex="1"/>
